...
const LandingPage =()=>{
  ...
  <h1 className="text-4xl font-bold text-black mb-2">Landing Page Title</h1>
...
<div className="flex w-full h-auto px-6 py-8">
  ...
  <div className="w-1/2 flex flex-col justify-start px-4">
    <div className="mb-6">
      <p className="text-start text-xl text-black-700">Musical Concerts</p>
    ...
    <div>
      <p className="text-start text-xl text-black-700">Conventions and Rallies</p>
      <p className="text-lg text-gray-600">
